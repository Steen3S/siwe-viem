...
class SiweMessage {
    ...
    constructor(param) {
        if (typeof param === 'string') {
            const parsedMessage = new parser_1.ParsedMessage(param);
            ...
            if (typeof this.chainId === 'string') {
                this.chainId = (0, parser_1.parseIntegerNumber)(this.chainId);
            }
        }
    ...
    verify(params, opts = { suppressExceptions: false }) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                let addr;
                try {
                    addr = yield (0, viem_1.recoverMessageAddress)({
                ...
                if (addr === this.address) {
                    ...
                    fail({
                        success: false,
                        data: this,
                        error: new types_1.SiweError(types_1.SiweErrorType.INVALID_ADDRESS, addr, this.address),
                    });
                }
            }));
        });
    ...
    validateMessage(...args) {
        ...
        if (!(0, parser_1.isEIP55Address)(this.address)) {
            throw new types_1.SiweError(types_1.SiweErrorType.INVALID_ADDRESS, (0, viem_1.getAddress)(this.address), this.address);
        }
